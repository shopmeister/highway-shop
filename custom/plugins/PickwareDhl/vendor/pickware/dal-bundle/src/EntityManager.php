...
class EntityManager
{
     ...
     */
    public function createVersion(string $entityDefinitionClassName, $primaryKey, Context $context, ?string $name = null): string
    {
     ...
     */
    public function lockPessimistically(string $entityDefinitionClassName, $criteria, Context $context): array
    {
