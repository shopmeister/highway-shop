...
class DefaultTranslationProvider
{
     ...
     *
     * @param array $payload DAL payload, i.e. an array of multiple entity payloads
     */
    ...
    /**
     * @param array $payload DAL payload of a single entity
     */
     ...
     */
    private function ensureSystemDefaultTranslations(&$translations): void
    {
