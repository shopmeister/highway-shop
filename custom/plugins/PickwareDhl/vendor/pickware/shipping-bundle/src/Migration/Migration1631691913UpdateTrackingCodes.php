...
class Migration1631691913UpdateTrackingCodes extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        foreach ($orderDeliveriesWithCancelledTrackingCodes as $orderDeliveryWithCancelledTrackingCodes) {
            $trackingCodes = json_decode($orderDeliveryWithCancelledTrackingCodes['trackingCodes']);
            $cancelledTrackingCodes = json_decode($orderDeliveryWithCancelledTrackingCodes['cancelledTrackingCodes']);
            ...
            if (count($uncancelledTrackingCodes) < count($trackingCodes)) {
                $connection->executeStatement(
                    ...
                    [
                        'trackingCodes' => json_encode($uncancelledTrackingCodes),
