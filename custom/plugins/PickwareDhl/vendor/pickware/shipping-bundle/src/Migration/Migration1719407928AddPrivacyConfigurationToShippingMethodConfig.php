...
class Migration1719407928AddPrivacyConfigurationToShippingMethodConfig extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        $connection->transactional(function(Connection $transaction): void {
            ...
            $update = $transaction->prepare(
                'UPDATE `pickware_shipping_shipping_method_config` SET `privacy_configuration` = :privacyConfiguration
                WHERE `id` = :id;',
            );
            foreach ($shippingMethodConfigCarriers as $shippingMethodConfigCarrier) {
                ...
                $update->executeStatement([
                    'privacyConfiguration' => json_encode($privacyConfiguration, JSON_THROW_ON_ERROR),
    ...
    private function findBooleanConfigValueForCarrier(
        ...
        return filter_var(
            json_decode($value, true, 512, JSON_THROW_ON_ERROR)['_value'],
