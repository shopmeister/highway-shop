...
class PickwareFeatureFlagBundle extends Bundle
{
    /**
    ...
    private static ?PickwareFeatureFlagBundle $instance = null;
    ...
    {
        $container->registerForAutoconfiguration(FeatureFlag::class)
            ->addTag('pickware_feature_flag.feature_flag');

        parent::build($container);

        $loader = new XmlFileLoader($container, new FileLocator(__DIR__));
        $loader->load('DependencyInjection/twig-extension.xml');
    }
