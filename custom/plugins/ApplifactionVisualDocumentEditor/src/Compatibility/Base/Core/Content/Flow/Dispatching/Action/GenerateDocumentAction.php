...
namespace Applifaction\DragNDropDocumentEditor\Compatibility\Base\Core\Content\Flow\Dispatching\Action;

use Applifaction\DragNDropDocumentEditor\Compatibility\Base\Core\Checkout\Document\Service\DocumentGenerator;
use Psr\Log\LoggerInterface;
use Shopware\Core\Checkout\Document\FileGenerator\FileTypes;
use Shopware\Core\Checkout\Document\Renderer\InvoiceRenderer;
use Shopware\Core\Checkout\Document\Struct\DocumentGenerateOperation;
use Shopware\Core\Content\Flow\Dispatching\Action\FlowAction;
use Shopware\Core\Content\Flow\Dispatching\Action\GenerateDocumentAction as CoreGenerateDocumentAction;
...
class GenerateDocumentAction extends FlowAction implements DelayableAction
{
    ...
    private CoreGenerateDocumentAction $coreAction;
    private DocumentGenerator $documentGenerator;
    private LoggerInterface $logger;

    public function __construct(
        CoreGenerateDocumentAction $coreAction,
    ...
    {
        return CoreGenerateDocumentAction::getName();
    }
    ...
    {
        return $this->coreAction->requirements();
    }
