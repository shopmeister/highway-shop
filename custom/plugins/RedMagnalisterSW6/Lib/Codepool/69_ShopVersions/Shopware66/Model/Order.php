...
class ML_Shopware66_Model_Order extends ML_Shopware6_Model_Order {
    ...
    public function getShopOrderStatusName() {
        try {
            echo print_m($this->getStateMachineStateEntity($this->getShopOrderObject()->getStateId())->getName());
