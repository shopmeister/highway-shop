...
<?php if ($this instanceof ML_Productlist_Controller_Widget_ProductList_Abstract) { ?>
    ...
    <div class="ml-container-action">
        ...
        <div class="ml-container-inner ml-container-md">
            <div style="display: flex; flex-direction: row-reverse">
                ...
                <div class="desc" id="desc_man_match" title="<?php echo MLI18n::gi()->ML_LABEL_INFOS; ?>" style="flex-grow: 0;flex-shrink: 0;margin-right: 6px;margin-top: 13px;">
                    <span><?php echo MLI18n::gi()->ML_AMAZON_LABEL_MANUAL_MATCHING; ?></span></div>
            </div>
            <div style="display: flex; flex-direction: row-reverse">
                <input type="button" class="mlbtn-red action" style="margin: 0px 3px 3px 3px;" value="<?php echo MLI18n::gi()->ML_AMAZON_LABEL_AUTOMATIC_MATCHING; ?>" id="automatching" name="automatching"/>
    ...
    <div id="noItemsInfo" class="dialog2" title="<?php echo MLI18n::gi()->ML_LABEL_NOTE; ?>"><?php echo MLI18n::gi()->ML_AMAZON_TEXT_MATCHING_NO_ITEMS_SELECTED; ?></div>
    <div id="manMatchInfo" class="dialog2" title="<?php echo MLI18n::gi()->ML_LABEL_INFORMATION.' '.MLI18n::gi()->ML_AMAZON_LABEL_MANUAL_MATCHING_POPUP; ?>"><?php echo MLI18n::gi()->get('PriceMinister_Productlist_Match_Manual_Desc'); ?></div>
    <div id="autoMatchInfo" class="dialog2" title="<?php echo MLI18n::gi()->ML_LABEL_INFORMATION.' '.MLI18n::gi()->ML_AMAZON_LABEL_AUTOMATIC_MATCHING_POPUP; ?>"><?php echo MLI18n::gi()->get('PriceMinister_Productlist_Match_Auto_Desc'); ?></div>
    <div id="confirmDiag" class="dialog2" title="<?php echo MLI18n::gi()->ML_LABEL_NOTE; ?>"><?php echo MLI18n::gi()->get('PriceMinister_Productlist_Match_Auto_Confirm'); ?></div>
