...
?>
    <table class="attributesTable">
        <?php foreach ($aField['subfields'] as $aSubField) { ?>
            ...
            <tr>
                <td style="border:none;"><?php echo $aSubField['i18n']['label']; ?>:</td>
...
<?php foreach ($aField['subfields'] as $aSubField) { ?>
    ...
    <div class="ml-modal" id="modal-<?php echo $aSubField['id']; ?>" title="<?php echo $aSubField['i18n']['label']; ?>">
        ...
        <span class="ml-js-ui-dialog-titlebar-additional">
                <a class="ui-icon ui-corner-all ui-state-focus global-ajax ui-icon-arrowrefresh-wrap ml-js-noBlockUi" href="<?php echo MLHttp::gi()->getUrl(array('mp' => MLModule::gi()->getMarketPlaceId(), 'controller' => 'do_categories', 'method' => 'getChildCategories', 'parentid' => 0, 'type' => $sType)); ?>">
