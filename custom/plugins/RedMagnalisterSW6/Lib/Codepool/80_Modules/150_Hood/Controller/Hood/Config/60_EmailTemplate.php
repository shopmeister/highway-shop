...
class ML_Hood_Controller_Hood_Config_EmailTemplate extends ML_Form_Controller_Widget_Form_ConfigAbstract {

    public static function getTabTitle() {
        return MLI18n::gi()->get('hood_config_account_emailtemplate');
    }
