...
MLI18n::gi()->add('formgroups_googleshopping', array(
    'account' => 'Google Shopping Account',
    'prepare' => 'Article preparation',
    'shipping' => array(
        'title' => 'Versand',
        'info' => 'Wählen Sie aus, welcher Versandservice für den Versand verwendet werden soll.',
    ),
    ...
    'prepare_variations' => 'Marktplatz Kategorie',
    'prepare_shippingtemplate' => 'Add shipping template',
));
