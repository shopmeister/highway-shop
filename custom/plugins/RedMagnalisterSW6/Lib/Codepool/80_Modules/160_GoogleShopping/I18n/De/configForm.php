...
MLI18n::gi()->googleshopping_config_account_title = 'Zugangsdaten';
MLI18n::gi()->googleshopping_config_account_prepare = 'Artikelvorbereitung';
MLI18n::gi()->googleshopping_config_account_price = 'Preisberechnung';
MLI18n::gi()->googleshopping_config_account_sync = 'Synchronisation';
MLI18n::gi()->googleshopping_config_account_orderimport = 'Bestellimport';
MLI18n::gi()->ML_GOOGLESHOPPING_ERROR_GOOGLESHOPPING_LANGUAGE_SET = 'Die GoogleShopping-Matching-Sprache ist in der Marktplatzkonfiguration nicht festgelegt (Artikelvorbereitung > Produktsprache Matching).';
