...
MLI18n::gi()->{'obi_config_order__legend__mwst'} = 'VAT';
MLI18n::gi()->{'obi_config_account__field__clientid__help'} = 'Enter your OBI Market Username';
MLI18n::gi()->{'obi_config_account_producttemplate'} = 'Produkt Template';
MLI18n::gi()->{'obi_config_general_nosync'} = 'keine Synchronisierung';
MLI18n::gi()->{'obi_config_free_text_attributes_opt_group_value'} = 'Associez-le au champ de texte libre sur une commande spécifique';
MLI18n::gi()->{'obi_config_account__field__clientid__label'} = 'OBI Market Username';
MLI18n::gi()->{'obi_configform_orderstatus_cancelreason__299'} = '{#i18n:obi_config_orderstatus_nopickup#}';
MLI18n::gi()->{'obi_config_account__legend__account'} = 'Access Data';
MLI18n::gi()->{'formfields__importactive__hint'} = '';
MLI18n::gi()->{'obi_configform_orderimport_payment_values__textfield__title'} = 'Aus Textfeld';
...
MLI18n::gi()->{'obi_configform_orderimport_payment_values__matching__title'} = 'Automatische Zuordnung';
MLI18n::gi()->{'obi_config_account__field__clientsecret__label'} = 'OBI Market Password';
MLI18n::gi()->{'formfields__stocksync.tomarketplace__help'} = '
            ...
            will be consided.
';
MLI18n::gi()->{'obi_config_order__field__importactive__hint'} = 'Please note: Orders from the OBI Market marketplace are automatically accepted when they are handed over to the web shop (order import).';
MLI18n::gi()->{'obi_configform_pricesync_values__auto'} = '{#i18n:obi_config_general_autosync#}';
MLI18n::gi()->{'obi_config_prepare__legend__upload'} = 'Product Upload';
...
MLI18n::gi()->{'obi_config_prepare__field__shippingtype__help'} = 'Enter witch shipping type. Available values PARCEL and FORWARDER';
...
MLI18n::gi()->{'formgroups_obi__orderstatus'} = 'Synchronisation des Bestell-Status vom Shop zu OBI Market';
MLI18n::gi()->{'obi_config_prepare__field__vat__matching__titledst'} = 'OBI Market Tax Codes';
MLI18n::gi()->{'formgroups_legend_quantity'} = 'Lager';
MLI18n::gi()->{'obi_config_matching_shop_values'} = 'Shop Values';
MLI18n::gi()->{'obi_configform_stocksync_values__rel'} = 'Bestellung reduziert Shop-Lagerbestand (empfohlen)';
MLI18n::gi()->{'obi_config_account__field__warehouseid__label'} = 'Warehouse ID';
MLI18n::gi()->{'obi_config_account__field__tabident__label'} = '{#i18n:ML_LABEL_TAB_IDENT#}';
MLI18n::gi()->{'obi_config_prepare__legend__prepare'} = 'Product Preparation';
MLI18n::gi()->{'obi_config_prepare__legend__shipping'} = 'Versand';
MLI18n::gi()->{'obi_config_orderstatus_nostock'} = 'pas de stock';
MLI18n::gi()->{'sObi_automatically'} = '-- allocate automatically --';
MLI18n::gi()->{'obi_config_orderstatus_nopickup'} = 'Non-collecte';
...
MLI18n::gi()->{'obi_config_account__field__clientsecret__help'} = 'Enter your OBI Market Password';
...
MLI18n::gi()->{'obi_config_order__legend__paymentandshipping'} = 'Payment and Shipping Service of the Orders';
MLI18n::gi()->{'obi_configform_orderimport_shipping_values__matching__title'} = 'Automatische Zuordnung';
MLI18n::gi()->{'obi_config_order__field__importactive__label'} = 'Activate Import';
MLI18n::gi()->{'obi_config_account__legend__tabident'} = 'Tab';
...
MLI18n::gi()->{'obi_config_orderstatus_customerwish'} = 'Demande du client';
MLI18n::gi()->{'obi_config_account_title'} = 'Access Data';
MLI18n::gi()->{'obi_config_prepare__field__processingtime__label'} = 'Lieferzeit in Werktagen';
MLI18n::gi()->{'obi_config_account_emailtemplate_sender'} = 'Beispiel-Shop';
MLI18n::gi()->{'obi_config_prepare__field__shippingtype__label'} = 'Shipping type';
...
MLI18n::gi()->{'obi_config_sync_inventory_import__false'} = 'Nein';
MLI18n::gi()->{'obi_config_order__legend__orderstatusimport'} = 'Order Status: Import (Marketplace to Shop)';
MLI18n::gi()->{'obi_config_prepare__field__vat__help'} = 'You must have at least one VAT defined in the shop system';
MLI18n::gi()->{'obi_config_orderstatus_wrongprice'} = 'prix erroné';
MLI18n::gi()->{'obi_config_prepare__field__vat__matching__titlesrc'} = 'Shop Tax Classes';
MLI18n::gi()->{'obi_config_free_text_attributes_opt_group'} = 'Champs supplémentaires';
...
MLI18n::gi()->{'obi_config_prepare__legend__pictures'} = 'Einstellungen f&uuml;r Bilder';
MLI18n::gi()->{'obi_config_order__legend__orderimport'} = 'Basic Order Settings';
MLI18n::gi()->{'obi_configform_orderimport_payment_values__textfield__textoption'} = '1';
MLI18n::gi()->{'obi_config_sync_inventory_import__true'} = 'Ja';
...
MLI18n::gi()->{'obi_config_account__field__warehouseid__help'} = '
                <p>Indiquez ici le Warehouse ID que vous avez reçu de OBI.</p>
            ';
...
MLI18n::gi()->{'obi_config_account_orderimport_returntrackingkey_info'} = 'For Standard Shipping Service "Return Tracking Key" is required filed on OBI Market marketplace. Since shop system does not provide such fields as standard option we need to match it to custom filed.';
MLI18n::gi()->{'obi_config_matching_obi_values'} = 'OBI Market Values';
MLI18n::gi()->{'obi_config_carrier_option_group_additional_option'} = 'Additional option:';
MLI18n::gi()->{'obi_config_prepare__field__vat__label'} = 'VAT';
MLI18n::gi()->{'obi_configform_sync_values__no'} = '{#i18n:obi_config_general_nosync#}';
MLI18n::gi()->{'obi_configform_orderimport_shipping_values__textfield__title'} = 'Aus Textfeld';
MLI18n::gi()->{'obi_config_order__legend__orderstatus'} = 'Order Status: Synchronisation (Shop to Marketplace)';
...
MLI18n::gi()->{'obi_config_prepare__field__processingtime__help'} = 'Tragen Sie hier ein, wie viele Werktage vom Zeitpunkt der Bestellung durch den Kunden es bis zum Erhalt des Pakets dauert';
