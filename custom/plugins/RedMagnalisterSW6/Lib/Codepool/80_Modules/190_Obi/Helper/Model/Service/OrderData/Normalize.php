...
class ML_Obi_Helper_Model_Service_OrderData_Normalize extends ML_Modul_Helper_Model_Service_OrderData_Normalize {
    ...
    protected function normalizeAddressSets () {
        ...
        $this->aOrder['AddressSets']['Main']['EMailIdent'] = $this->obiFindCustomerIdent(
            $buyerId,
    ...
    protected function obiFindCustomerIdent ($sBuyer, $sDefault) {
    ...
    protected function normalizeMpSpecific () {
        ...
        $this->aOrder['MPSpecific']['InternalComment'] =
            ...
            MLModule::gi()->getMarketPlaceName(false).' '.MLI18n::gi()->get('ML_LABEL_ORDER_ID').': '.$this->aOrder['MPSpecific']['ObiOrderId']."\n\n"
