    ...
    <?php
        ...
        foreach ($aField['subfields'] as $aCurrentField) {
            ...
            ?>
                <tr>
                    <?php if ($i == 1) { ?>
                        <td style="border:none;"><?php echo MLI18n::gi()->get('ML_OBI_ORDER_STATUS'); ?>:</td>
...
<style>
    #obi_config_order_field_orderstatus_shipped_duplicate div {
        display: flex;
        border: 0 !important;
    }

    #obi_config_order_field_orderstatus_shipped_duplicate div div {
    ...
    #obi_config_order_field_orderstatus_shipped_duplicate div span {
        border: 0 !important;
    }
</style>
