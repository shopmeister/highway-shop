...
<div class="ml-container-action">
    <div class="ml-container-inner ml-container-sm">
        <input type="button" class="mlbtn" value="<?php echo $this->__('ML_BUTTON_LABEL_DELETE') ?>" id="listingDelete" name="<?php echo MLHttp::gi()->parseFormFieldName('listing[delete]'); ?>" disabled="disabled"/>
        <div class="mltooltip" id="mltooltip"><?php echo $this->__('ML_OBI_DElETE_BUTTON_PROUCT_TOOLTIP') ?></div>
    </div>
...
<script type="text/javascript">/*<![CDATA[*/
    jqml(document).ready(function() {
        ...
        jqml('.ml-container-inner.ml-container-sm').mouseover(function(event) {
            tooltip.css({
                'display': 'block',
            })
        });
        jqml('.ml-container-inner.ml-container-sm').mouseleave(function(event) {
            tooltip.css({
                'display': 'none',
            })
        });
