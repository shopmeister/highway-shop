...
class ML_Ricardo_Controller_Ricardo_Config_Account extends ML_Form_Controller_Widget_Form_ConfigAbstract {

    public static function getTabTitle() {
        return MLI18n::gi()->get('ricardo_config_account_title');
    }
