 ...
 * -----------------------------------------------------------------------------
 */
class ML_Hitmeister_Model_ProductListDependency_HitmeisterPrepareTypeFilter extends ML_Productlist_Model_ProductListDependency_Abstract {
    ...
    protected function getFilterValues () {
        $aValues = array();
        foreach (array('apply' => 'apply', 'match' => 'match') as $sFilterKey => $sFilterValue) {
            $aValues[$sFilterKey] = array(
                'value' => $sFilterKey,
                'label' => $sFilterValue
            );
        }
