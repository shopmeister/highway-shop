    ...
    <tr>
        <td class="fullWidth">
            <table>
                <tbody>
                <tr>
                    <td><?= $this->__('ML_HITMEISTER_LABEL_LAST_REPORT') ?>
...
<div id="infodiag" class="dialog2" title="<?= $this->__('ML_LABEL_NOTE') ?>"><?= $this->__('ML_HITMEISTER_TEXT_CHECKIN_DELAY') ?></div>
<script type="text/javascript">/*<![CDATA[*/
    jqml(document).ready(function () {
        jqml('#hitmeisterInfo').click(function () {
