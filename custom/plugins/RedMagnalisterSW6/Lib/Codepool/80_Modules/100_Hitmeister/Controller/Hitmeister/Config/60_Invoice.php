...
class ML_Hitmeister_Controller_Hitmeister_Config_Invoice extends ML_Form_Controller_Widget_Form_ConfigInvoiceAbstract {
    ...
    public static function getTabTitle() {
        return MLI18n::gi()->get('hitmeister_config_invoice');
    }
