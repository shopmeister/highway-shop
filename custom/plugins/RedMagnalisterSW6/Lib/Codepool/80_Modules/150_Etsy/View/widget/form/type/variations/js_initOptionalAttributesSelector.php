        ...
        $(document).ready(function() {
            ...
            function initOptionalAttributesSelector() {
                ...
                jqml.each(optionalAttributesIdAndMapValues, function (optionalFieldsetElId, optionalAttributesMap) {
                    ...
                    var className = 'optionalAttribute';
                    if (optionalFieldsetElId.indexOf("_extra_") !== -1) {
                        className = 'optionalAttributeExtra';
                    }
                    if (sizeOfOptionalAttributes > optionalAttributesMaxSize) {
                        $([
                            '<tr class="js-field hide '+className+' dont_use_sub">',
                    ...
                    if (optionalFieldsetElId.indexOf("_extra_") !== -1) {
                        attributesSelectorEl = jqml([
                            '<select class="ml-searchable-select" name="extra_optional_selector" style="width: 100%">',
                    ...
                    function changeCurrentAttribute(attributeIdToShow) {
                        ...
                        if (sizeOfOptionalAttributes > optionalAttributesMaxSize) {
                            optionalFieldsetEl.find('.' + className).addClass('hide').hide();
                        }
                        ...
                        jqml('#' + attributeIdToShow).on('select2:open', function (e) {
                            ...
                            // disable all variation options for the category optional attributes
                            if (attributeIdToShow.indexOf('_extra_') != -1) {
                                select.find('optgroup.variation option').prop('disabled', true);
                            }
                        });
                    }
                    ...
                    jqml('select[name="optional_selector"], select[name="extra_optional_selector"]').each(function (index, link) {
            ...
            // disable all variation options for the category optional attributes
            $('select[id*=_extra_]').each(function() {
                $(this).find('optgroup.variation option').prop('disabled', true);
            });
        });
    })(jqml);
</script>
