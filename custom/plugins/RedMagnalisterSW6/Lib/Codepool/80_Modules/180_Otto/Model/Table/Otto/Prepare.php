...
class ML_Otto_Model_Table_Otto_Prepare extends ML_Database_Model_Table_Prepare_Abstract {
    ...
    protected $aFields = array(
        ...
        'MainImage' => array(
            'Type' => 'varchar(500)', 'Null' => self::IS_NULLABLE_YES, 'Default' => null, 'Extra' => '', 'Comment' => ''
        ),
        ...
        'DeliveryType' => array(
            'Type' => "enum('PARCEL','FORWARDER_PREFERREDLOCATION','FORWARDER_CURBSIDE')", 'Null' => self::IS_NULLABLE_YES, 'Default' => null, 'Extra' => '', 'Comment' => ''
        ),
        'DeliveryTime' => array(
            'Type' => 'tinyint(4)', 'Null' => self::IS_NULLABLE_YES, 'Default' => null, 'Extra' => '', 'Comment' => ''
        ),
        'ShippingProfile' => array(
            'Type' => 'varchar(256)', 'Null' => self::IS_NULLABLE_NO, 'Default' => null, 'Extra' => '', 'Comment' => ''
        ),
        'ProcessingTime' => array(
            'Type' => 'varchar(10)', 'Null' => self::IS_NULLABLE_NO, 'Default' => 'DEFAULT', 'Extra' => '', 'Comment' => ''
        ),
