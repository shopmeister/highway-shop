...
class ML_Otto_Controller_Otto_Errorlog extends ML_ErrorLog_Controller_Widget_ErrorLog_Abstract {
    ...
    public function getFields() {
        return array(
            ...
            'ErrorCode' => array(
                'Label' => $this->__('ML_OTTO_ERROR_CODE'),
                'Field' => 'errorcode',
            ),
            'ErrorMessage' => array(
            ...
            'DateAdded' => array(
                'Label' => $this->__('ML_LABEL_CHANGELOG_DATE'),
                'Sorter' => 'dateadded',
                'Field' => 'dateadded',
            ),
        );
    ...
    public function getErrorcode($oErrorlog) {
        $sErrorCode = $oErrorlog->get('ErrorCode');
        echo !empty($sErrorCode) && !$this->isUnixTimestamp($sErrorCode) ? $sErrorCode:'';
    }
