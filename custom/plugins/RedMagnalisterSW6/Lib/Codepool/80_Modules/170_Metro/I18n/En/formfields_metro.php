...
MLI18n::gi()->add('formfields_metro', array(
    ...
    'prepare_feature' => array(
        ...
        'hint' => 'Maximum 200 characters per feature.<br>The field is automatically pre-filled with the product meta description and separated into individual bullet points by commas.',
        'optional' => array(
            'checkbox' => array(
                'labelNegativ' => '{#i18n:ML_PRODUCTPREPARATION_ALWAYS_USE_FROM_WEBSHOP#}',
            ),
    ...
    'orderstatus.carrier'            => array(
        'label' => '&nbsp;&nbsp;&nbsp;&nbsp;Carrier',
        'help'  => 'When confirming the shipment, the carrier stored here is automatically transmitted to Metro.',
    ),
