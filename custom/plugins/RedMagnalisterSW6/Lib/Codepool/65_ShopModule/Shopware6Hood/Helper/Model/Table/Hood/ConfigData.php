 ...
 * -----------------------------------------------------------------------------
 */
MLFilesystem::gi()->loadClass('Hood_Helper_Model_Table_Hood_ConfigData');

class ML_Shopware6Hood_Helper_Model_Table_Hood_ConfigData extends ML_Hood_Helper_Model_Table_Hood_ConfigData {

    public function orderimport_paymentmethodField(&$aField) {
        $aMatching = MLI18n::gi()->get('hood_configform_orderimport_payment_values');
        $aField['values'] =
    ...
    public function orderimport_shippingmethodField(&$aField) {
        $aMatching = MLI18n::gi()->get('hood_configform_orderimport_shipping_values');
        $aField['values'] =
        array('matching' => $aMatching['matching']['title'])
         +
