...
class ML_Shopware6Cdiscount_Model_ProductList_Cdiscount_Prepare_Match extends ML_Shopware6_Model_ProductList_Abstract {
    ...
    protected function executeFilter(){
        $this->oFilter
            ...
            ->registerDependency('cdiscountpreparetypefilter',array('PrepareType'=>'match'))
