 ...
 */
 ...
 class ML_Shopware6GoogleShopping_Model_ProductList_GoogleShopping_Prepare_Apply extends ML_Shopware6_Model_ProductList_Abstract {
     protected function executeFilter() {
         $this->oFilter
            ...
            ->registerDependency('googleshoppingpreparetypefilter', array('PrepareType'=>'apply'))
            //->registerDependency('shopwareproducttypefilter')
