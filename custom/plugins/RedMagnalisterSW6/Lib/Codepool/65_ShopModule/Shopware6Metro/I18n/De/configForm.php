...
MLI18n::gi()->{'metro_config_order__field__customergroup__help'} = '{#i18n:global_config_orderimport_field_customergroup_help#}';
...
MLI18n::gi()->{'metro_config_order__field__orderimport.paymentstatus__label'} = 'Zahlstatus im Shop';
MLI18n::gi()->{'metro_config_order__field__orderimport.paymentstatus__help'} = '<p>Metro &uuml;bergibt beim Bestellimport keine Information der Versandart.</p>
