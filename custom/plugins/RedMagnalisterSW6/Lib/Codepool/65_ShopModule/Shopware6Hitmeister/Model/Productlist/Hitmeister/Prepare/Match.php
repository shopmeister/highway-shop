...
class ML_Shopware6Hitmeister_Model_ProductList_Hitmeister_Prepare_Match extends ML_Shopware6_Model_ProductList_Abstract {
    ...
    protected function executeFilter(){
        $this->oFilter
            ...
            ->registerDependency('hitmeisterpreparetypefilter',array('PrepareType'=>'match'))
