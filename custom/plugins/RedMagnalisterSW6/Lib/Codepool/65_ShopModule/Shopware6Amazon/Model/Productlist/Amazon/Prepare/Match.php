...
class ML_Shopware6Amazon_Model_ProductList_Amazon_Prepare_Match extends ML_Shopware6_Model_ProductList_Abstract {
    ...
    protected function executeFilter(){
        $this->oFilter
            ...
            ->registerDependency('amazonpreparetypefilter',array('PrepareType'=>'match'))
