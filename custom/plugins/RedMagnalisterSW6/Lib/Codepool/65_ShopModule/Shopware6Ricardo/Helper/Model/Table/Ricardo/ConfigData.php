 ...
 * -----------------------------------------------------------------------------
 */
MLFilesystem::gi()->loadClass('Ricardo_Helper_Model_Table_Ricardo_ConfigData');

class ML_Shopware6Ricardo_Helper_Model_Table_Ricardo_ConfigData extends ML_Ricardo_Helper_Model_Table_Ricardo_ConfigData {
...
//            'freeText',
            'defaultFieldValue'
        ), $aField, 'carrier', 'GetOrderStatusData');
