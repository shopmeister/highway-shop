...
class ML_Sync_Controller_Frontend_Do_SyncInventory extends ML_Core_Controller_Abstract {
    ...
    public function execute(){
        ...
        try{
            ...
            foreach(MLModule::getMarketplaceHelper()->magnaGetInvolvedMarketplaces() as $sMarketPlace){
                foreach(MLModule::getMarketplaceHelper()->magnaGetInvolvedMPIDs($sMarketPlace) as $iMarketPlace){
        ...
        if (MLSetting::gi()->blDev === true) {
            $this->out(MLDatabase::getDbInstance()->getTimePerQuery());
        }
