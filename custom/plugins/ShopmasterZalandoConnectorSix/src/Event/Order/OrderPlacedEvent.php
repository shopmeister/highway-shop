...
class OrderPlacedEvent extends ZalandoEvent implements SalesChannelAware, OrderAware, MailAware, CustomerAware, FlowEventAware
{
    final public const EVENT_NAME = 'zalando.order.placed';
